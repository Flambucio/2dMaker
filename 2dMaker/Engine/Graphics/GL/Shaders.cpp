...
int Shaders::CompileShader(GLuint type, const std::string& source)
{
...
std::string Shaders::ReadShaderFile(const std::string& path)
{
...
ShaderSources Shaders::ParseShader(const std::string& path)
{
...
GLuint Shaders::CreateShaderProgram()
{
